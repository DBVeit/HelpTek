...
BEGIN
	...
	INSERT INTO chamados(id_user,titulo_chamado,descricao_chamado,gravidade,urgencia,tendencia,prioridade_chamado,data_atualizacao,id_usuario_atual,total_acoes)
	VALUES(p_id_user,p_titulo_chamado,p_descricao_chamado,p_gravidade,p_urgencia,p_tendencia,p_prioridade_chamado,NOW(),p_id_user,1);
...
-- Dump completed on 2024-09-28 23:07:12
