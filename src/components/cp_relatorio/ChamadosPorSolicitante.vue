<template>
  <div class="component-main-container">
    <div class="form-relatorio">
        ...
        <div class="form-group">
          ...
          <select v-model="RelatorioParam.solicitante_chamado">
            ...
            <option
              ...
              :key="solicitante.id_user"
              :value="solicitante.id_user"
            >
              {{ solicitante.idfr_code_user }} - {{ solicitante.name_user }} ({{
                solicitante.id_user
              }})
            </option>
          </select>
      ...
      <div class="form-group-relatorio-acao" v-if="showResults">
        <div class="result-relatorio">
          <span>Total de resultados encontrados: {{ totalResults }}</span>
          <br />
          <a class="link-gerar-relatorio" @click="generateExcelReport"
            >Gerar relatório
            <svg
...
export default {
  ...
  created() {
    this.fetchUserSolicitante();
  },
  methods: {
    fetchUserSolicitante() {
      axios
        .get(
          "http://localhost/projeto/helptek/php/api/functions/fetch/getUserSolicitante.php"
        )
        .then((response) => {
    ...
    onSelectParamRel() {
      ...
      relatorio.append("dta_criacao_fim", this.RelatorioParam.dta_criacao_fim);

      axios
        .post(
          `http://localhost/projeto/helptek/php/api/functions/relatorios/getChamadosSolicitante.php`,
          relatorio
        )
        .then((res) => {
    ...
    generateExcelReport() {
      ...
      // Faz a solicitação para gerar o Excel
      axios({
        url: `http://localhost/projeto/helptek/php/api/functions/relatorios/generateChamadosExcel.php`,
        method: "POST",
        data: relatorio,
        ...
        .then((response) => {
          ...
          link.href = url;
          link.setAttribute("download", "relatorio_chamados.xlsx"); // Nome do arquivo
