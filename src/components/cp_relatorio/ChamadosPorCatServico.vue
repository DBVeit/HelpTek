  ...
  <div class="component-main-container">
    <form @submit.prevent="onSelectParamRel">
      <div class="form-group">
        ...
        <select v-model="RelatorioParam.cat_servico">
...
export default {
  ...
  methods: {
    onSelectParamRel() {
      ...
      relatorio.append("cat_servico", this.RelatorioParam.cat_servico);
      ...
      axios
        .post(
          `http://localhost/projeto/helptek/php/api/functions/relatorios/getChamadosCatServico.php`,
          relatorio
        )
        .then((res) => {
