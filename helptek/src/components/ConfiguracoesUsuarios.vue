      ...
      <div class="form_cadastro">
        ...
        <transition name="fade">
          <div v-if="alertMessage" class="alert-container">
            <div class="alert" :style="{ backgroundColor: '#ff5757' }">
              {{ alertMessage }}
            </div>
          </div>
        </transition>
...
export default {
  ...
  methods: {
    ...
    onCriarUsuario() {
      ...
      data.append("usuario", this.UsuarioData.username_name); // Corrigido para 'usuario'
    ...
    showAlert(message) {
      ...
      setTimeout(() => {
        this.alertMessage = "";
      }, 4000); // O alerta desaparece após 3 segundos
    },
    testAlert() {
      this.showAlert("Este é um alerta de teste!"); // Exemplo de mensagem de alerta de teste
    },
  },
};
</script>
...
.alert-container {
  ...
  background-color: #ff5757; /* Cor de fundo do alerta */
  padding: 15px;
