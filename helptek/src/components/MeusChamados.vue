<template>
  <div class="ticket-form-container">
    ...
    <div>
      ...
      <!-- Exibe a mensagem quando nenhum resultado é encontrado -->
    ...
    filterChamados() {
      ...
      axios
        ...
        .then((response) => {
          ...
          this.noResultsMessage = this.Chamados.length === 0; // Verifica se a lista está vazia
        })
        .catch((error) => {
...
<style scoped>
/* Estilos scoped para o componente Vue */
/* Estilos para a mensagem de nenhum resultado encontrado */
.no-results-message {
  margin-top: 20px;
  padding: 10px;
